...
cursor_img = pygame.transform.scale(pygame.image.load(os.path.join("cursor.png")),(40,40))
...
BG_IMAGE = pygame.image.load(os.path.join("CityBG.png"))
BG = pygame.transform.scale(BG_IMAGE, (WIDTH, HEIGHT))

MAINCHAR_IMAGE = pygame.image.load(os.path.join("MainCharacter.png"))
MAINCHAR = pygame.transform.scale(MAINCHAR_IMAGE, (150, 300))

SHOTGUN_IMAGE = pygame.image.load(os.path.join("Shotgun.png"))
SHOTGUN = pygame.transform.scale(SHOTGUN_IMAGE, (130,100)).convert_alpha()
shotgun_x = 200
shotgun_y = 270

BULLET_SHOOTING_IMAGE = pygame.image.load(os.path.join("BULLET_SHOOTING.png"))
BULLET_SHOOTING = pygame.transform.scale(BULLET_SHOOTING_IMAGE, (50, 50))

BULLET_SHOOTING_SOUND = pygame.mixer.Sound(os.path.join("gunshot.mp3"))
ENEMY_BLAST_SOUND = pygame.mixer.Sound(os.path.join("explosion.mp3"))
